...
(function(demo) {
  ...
  var DemoIconsWorld = (function(_super) {
    ...
    function DemoIconsWorld() {
        ...
        this.CANVAS_W = 240;
        this.CANVAS_H = 40;
        this.WORD_LIST = ["DISCOVERILLA", "ETHEREUM", "ADS PLATFORM"];
        this._matrixLength = 16;
        this._particleList = [];
        this._wordIndex = 0;
        /** 色相 0.0〜1.0 */
        this._hue = 0.6;
    ...
    DemoIconsWorld.prototype.setup = function() {
      ...
      // 背景の作成
      // ------------------------------
      var plane = new THREE.PlaneBufferGeometry(30000, 30000, 1, 1);
    ...
    DemoIconsWorld.prototype.createParticleCloud = function() {
      ...
      // マテリアルを作成
      var texture = THREE.ImageUtils.loadTexture('./bubble.jpg');
